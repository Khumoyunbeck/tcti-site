                    ...
                    <div className="col-12">
                        ...
                        <div className="card-body">
                            ...
                            <form autoComplete="off" className="el_form page_form" onSubmit={(e) => {
                                ...
                                fetch('http://localhost:3001/sub_categories/edit', {
                                    method: 'POST',
                                    headers: {
                                      'Accept': 'application/json',
                                      'Content-Type': 'application/json'
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-sm-10" >
                                <select className="filter_selector form-control" name="menu_id" defaultValue={found.filter_id} ref={page_filter_id}>
                                    <option value="0">Kerak emas</option>
